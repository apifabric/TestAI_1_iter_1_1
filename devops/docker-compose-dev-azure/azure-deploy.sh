...
resourcename="testai1iter11"  # lower case, only
resourcegroup="testai1iter11_rg"
...
# git clone https://github.com/apilogicserver/testai1iter11.git
# cd testai1iter11
...
az group create --name testai1iter11_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group testai1iter11_rg --sku S1 --is-linux
az container create --resource-group testai1iter11_rg --name testai1iter11 --image apilogicserver/testai1iter11:latest --dns-name-label testai1iter11 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//testai1iter11.westus.azurecontainer.io:5656'
